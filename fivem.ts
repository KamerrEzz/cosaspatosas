...
const getOauthState = (stateKern: string) => {
  ...
  console.log({ getOauthState: stateSeed });
...
export default class CitizenFXProvider {
  ...
  constructor() {
    ...
    const fivemIssuer = new Issuer({
      issuer: "https://idms.fivem.net",
      jwks_uri: "https://idms.fivem.net/.well-known/openid-configuration/jwks",
      authorization_endpoint: "https://idms.fivem.net/connect/authorize",
      token_endpoint: "https://idms.fivem.net/connect/token",
      userinfo_endpoint: "https://idms.fivem.net/connect/userinfo",
      end_session_endpoint: "https://idms.fivem.net/connect/endsession",
      check_session_iframe: "https://idms.fivem.net/connect/checksession",
      revocation_endpoint: "https://idms.fivem.net/connect/revocation",
      introspection_endpoint: "https://idms.fivem.net/connect/introspect",
      device_authorization_endpoint:
        "https://idms.fivem.net/connect/deviceauthorization",
      frontchannel_logout_supported: true,
      frontchannel_logout_session_supported: true,
      backchannel_logout_supported: true,
      backchannel_logout_session_supported: true,
      scopes_supported: ["openid", "email", "identify", "offline_access"],
      claims_supported: [
        "sub",
        "email",
        "email_verified",
  ...
  async processCallback(
    ...
    if (typeof tokenSet !== "object")
      throw new Error("tokenSet is not an object");
    if (typeof tokenSet.access_token == "undefined")
      throw new Error("access_token not present");
    if (typeof tokenSet.expires_at == "undefined")
      throw new Error("expires_at not present");
    return tokenSet;
  }
